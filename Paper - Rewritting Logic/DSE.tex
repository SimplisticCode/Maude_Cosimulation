...
To explore different instrumentations of a \emph{partially instrumented} scenario, we declare the contract of all the inputs, which contract is unknown, to be \texttt{noContract}.
