...
Examples include population growth, water flow, and pendulums. \simon{More advanced examples}
...
We can use Dijkstra's weakest precondition calculus~\simon{Add reference} to check if all actions of $P$ is enabled.
