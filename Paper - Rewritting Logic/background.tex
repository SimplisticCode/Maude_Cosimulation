...
Complex scenarios are subject to algebraic loops~\cite{Kubler2000} (\cref{fig:algebraic_example}) or step rejections~\cite{thrane2021} (\cref{fig:step_finding_scenario}).
