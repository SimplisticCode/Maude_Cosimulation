...
available at \url{URL-HERE} \simon{create link} and consists of around 
\simon{find out} LOC. 
...
\texttt{Connection} of sort \texttt{Configuration}.  \peter{why not
  use the object names are they are???}
