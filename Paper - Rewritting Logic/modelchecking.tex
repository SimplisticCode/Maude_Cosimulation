...
The rewriting states from a consistent initial state like the state shown in \simon{add reference} and explores how it using the rewrite rules can establish a consistent final state.
